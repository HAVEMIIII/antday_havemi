            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#" class="image">
                                <img class="pic-1" src="http://www.free-css.com/assets/files/free-css-templates/preview/page219/garage/assets/image/featurporch3.jpg">
                            </a>
                            <a class="add-to-cart" href=""> + </a>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#" class="image">
                                <img class="pic-1" src="http://www.free-css.com/assets/files/free-css-templates/preview/page219/garage/assets/image/featurporch2.jpg">
                            </a>
                            <a class="add-to-cart" href=""> + </a>
                        </div>
                        <div class="product-content">
